...
const Map<String, AuthError> authErrorMapping = {
  ...
  'requires-recent-login': AuthErrorRequiredRecentLogin(),
...
class AuthErrorUnknown extends AuthError{
  ...
  const AuthErrorUnknown(this.innerException):super(
...
@immutable
class AuthErrorRequiredRecentLogin extends AuthError {
  const AuthErrorRequiredRecentLogin()
      : super(
